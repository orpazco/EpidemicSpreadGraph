...
void Tester::runTests() {
    ...
    if (resultFile.is_open()) {
        ...
        std::ofstream MyFile("../testsResults.txt");
        int testCntr = 1;
        ...
        while (std::getline(resultFile, line)) {
            ...
            if(resultStr == testResult) {
                ...
                // write to file
                MyFile << "=======================================================" << "TEST NUMBER " << testCntr << "=======================================================" << std::endl;
                MyFile << "Failed Test ! " << " | Test Input : " << j << " | " << std::endl;
                MyFile << "Your Result -> " << resultStr << " \rTest Result-> "<<testResult << std::endl;
                MyFile << std::endl;
                testCntr++;
            }
        }
